...
if (isset($_GET['id'])) {
	...
	include_once(__DIR__ . "/../config.php");
	$url_id = $_GET['url'];
	$sani_url = filter_var($url_id, FILTER_SANITIZE_STRING);
	if (!preg_match('/[^a-z_\-0-9]/i', $sani_url)) {
		...
		<div class="highInfo">
			...
			<div class="playerDiv">
				<div class="videoPlayers">
                    <?php if ($row['youtube_url']) : ?>
						<iframe src="https://www.youtube-nocookie.com/embed/<?php echo $row['url'] ?>" height="720" width="1280" frameborder="0" preload="metadata" allow="encrypted-media" allowfullscreen></iframe>
                    <?php else : ?>
