        ...
        <div id="main-content">
            <div class="clipofday">
                ...
                <?php if ($row['youtube_url']) : ?>
                    <iframe src="<?php echo $row['embed_url']; ?>" title="<?php echo $row['title']; ?>" height="720" width="1280" frameborder="0" preload="metadata" allow="encrypted-media" allowfullscreen></iframe>
                <?php else : ?>
